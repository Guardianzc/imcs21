# This script is used to reproduce the figures in the paper.
import json
import numpy as np
...
with PdfPages('et_dist.pdf') as pdf:
    plt.clf()
    # 数据
    # group_names = ['Symptom', 'Examination', 'Drug', 'Drug Category', 'Operation']
...
with PdfPages('da_dist.pdf') as pdf:
    ...
    # 定义标签名称
    group_names = ['R-ETIOL', 'R-PRCTN', 'R-MA', 'I-ETIOL', 'DIAG', 'R-PC', 'R-DR', 'I-MA', 'R-EET', 'I-PC',
...
with PdfPages('da_pos.pdf') as pdf:
    ...
    # 图中的标签
    x_label = ['0%-20%', '20%-40%', '40%-60%', '60%-80%', '80%-100%']
    y_label = ['R-PC', 'I-PC', 'R-SX', 'I-SX', 'R-ETIOL', 'I-ETIOL', 'R-EET', 'I-EET',
