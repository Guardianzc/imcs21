...
python inference.py --target exp --cuda_num 0 --epoch 50
cd .. || exit
...
python inference.py --target imp --cuda_num 1 --epoch 50
cd .. || exit
python eval_sri.py --target imp --gold ../../dataset/test.json --pred MLC-SRI/mlc_imp_pred.json
