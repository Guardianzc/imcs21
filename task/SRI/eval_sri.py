...
def labels_metric(golds, preds):
    labels = classification_report(gold_labels, pred_labels, output_dict=True)
    print('F1-score -> positive: {}, negative: {}, uncertain: {}'.format(
        labels['1']['f1-score'], labels['0']['f1-score'], labels['2']['f1-score']))
